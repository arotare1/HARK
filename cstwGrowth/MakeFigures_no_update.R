...
high_growth <- read.csv("../NoUpdate/HighGrowth/Dist.csv")
no_growth <- read.csv("../NoUpdate/NoGrowth/Dist.csv")

high_growth %<>% filter(annual_growth<=1.07)
no_growth %<>% filter(annual_growth<=1.07)
...
ggsave("m2m_no_update_high_growth.pdf", plot = m2m_no_update, device = "pdf", width = 8, height = 4)
ggsave("../../tex/m2m_no_update_high_growth.pdf", plot = m2m_no_update, device = "pdf", width = 8, height = 4)
...
m2m_no_update <- grid.arrange(arrangeGrob(panel_a + theme(legend.position="none", plot.margin = unit(c(0.3,0.3,0.3,0.3), "cm")),
                                          ...
                                          nrow = 1),
                              g_legend(panel_a), nrow = 2, heights = c(10,1))
ggsave("m2m_no_update_no_growth.pdf", plot = m2m_no_update, device = "pdf", width = 8, height = 4)
ggsave("../../tex/m2m_no_update_no_growth.pdf", plot = m2m_no_update, device = "pdf", width = 8, height = 4)
...
gini_no_update <- grid.arrange(arrangeGrob(panel_a + theme(legend.position="none", plot.margin = unit(c(0.3,0.3,0.3,0.3), "cm")),
                                           ...
                                           nrow = 1),
                               g_legend(panel_a), nrow = 2, heights = c(10,1))
ggsave("gini_no_update_high_growth.pdf", plot = gini_no_update, device = "pdf", width = 8, height = 4)
ggsave("../../tex/gini_no_update_high_growth.pdf", plot = gini_no_update, device = "pdf", width = 8, height = 4)

panel_a <- ggplot(no_growth %>% filter(variable=="Lvl_gini" |
                                           variable=="Lvl_gini_no_update"),
                  aes(x = annual_growth-1, y = value, color = variable)) +
  geom_line() +
  geom_point() +
...
panel_b <- ggplot(no_growth %>% filter(variable=="Nrm_gini" |
                                           variable=="Nrm_gini_no_update"),
                  aes(x = annual_growth-1, y = value, color = variable)) +
  geom_line() +
  geom_point() +
...
gini_no_update <- grid.arrange(arrangeGrob(panel_a + theme(legend.position="none", plot.margin = unit(c(0.3,0.3,0.3,0.3), "cm")),
                                          ...
                                          nrow = 1),
                              g_legend(panel_a), nrow = 2, heights = c(10,1))
ggsave("gini_no_update_no_growth.pdf", plot = gini_no_update, device = "pdf", width = 8, height = 4)
