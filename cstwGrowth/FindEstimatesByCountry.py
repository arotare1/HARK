...
# Find estimates for each country
...
for country in country_list:
    ...
    if do_actual_KY:
        ...
        KY_target = 10.26
    estimation_growth = pd.read_csv(path_to_lorenz)['growth_before_wb'].values[0]**0.25
    estimation_year = pd.read_csv(path_to_lorenz)['now'].values[0]
    ...
    if do_high_CRRA:
        PerpetualYouthType.CRRA = 2.0       # Update CRRA
