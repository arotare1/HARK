...
# Create list of possible parameter specifications
...
# Use just beta-point specification(s) for now
spec_list = ['ParamsBetaPointPYnw']


# Loop over specifications and compute results
